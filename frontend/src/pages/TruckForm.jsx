  ...
  return (
    <MobileLayout title={isEditing ? 'Edit Truck' : 'Add Truck'}>
      ...
      <div className="relative h-[420px]">
        <MapComponent
          trucks={formData.currentLocation && formData.currentLocation.coordinates && formData.currentLocation.coordinates.length === 2 ? 
            [{
              _id: 'preview',
              licensePlate: formData.licensePlate || 'New Truck',
          ...
          showAllMarkersOnLoad={formData.currentLocation && formData.currentLocation.coordinates && formData.currentLocation.coordinates.length === 2}
          centerCoordinates={formData.currentLocation && formData.currentLocation.coordinates && formData.currentLocation.coordinates.length === 2 ? 
            [formData.currentLocation.coordinates[1], formData.currentLocation.coordinates[0]] : null}
          zoom={formData.currentLocation && formData.currentLocation.coordinates && formData.currentLocation.coordinates.length === 2 ? 15 : 10}
        />
      </div>
